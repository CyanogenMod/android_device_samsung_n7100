...
struct route_setting earpiece_input[] = {
    { .ctl_name = "AIF2DAC2L Mixer AIF2 Switch", .intval = 0, },
    { .ctl_name = "AIF2DAC2R Mixer AIF2 Switch", .intval = 0, },
    ...
    { .ctl_name = "Left Output Mixer DAC Volume", .intval = 7, },
    { .ctl_name = "Right Output Mixer DAC Volume", .intval = 7, },
    { .ctl_name = "Output Volume", .intval = 57, },
    { .ctl_name = "Earpiece Volume", .intval = 1, },
    { .ctl_name = NULL, },
};

struct route_setting earpiece_input_disable[] = {
    { .ctl_name = "AIF1DAC1 Volume", .intval = 96, },
    { .ctl_name = "AIF2DAC Volume", .intval = 96, },
    { .ctl_name = "AIF1 Boost Volume", .intval = 0, },
    { .ctl_name = "AIF2 Boost Volume", .intval = 0, },
    ...
    { .ctl_name = "Left Output Mixer DAC Volume", .intval = 7, },
    { .ctl_name = "Right Output Mixer DAC Volume", .intval = 7, },
    { .ctl_name = "Output Volume", .intval = 61, },
    { .ctl_name = "Earpiece Volume", .intval = 1, },
    { .ctl_name = NULL, },
};
...
struct route_setting speaker_input[] = {
    ...
    { .ctl_name = "AIF2ADC HPF Mode", .intval = 1, },
    { .ctl_name = "AIF2ADC HPF Switch", .intval = 1, },
    { .ctl_name = "AIF1DAC1 Volume", .intval = 90, },
    { .ctl_name = "AIF2DAC Volume", .intval = 96, },
    { .ctl_name = "AIF1 Boost Volume", .intval = 0, },
    { .ctl_name = "AIF2 Boost Volume", .intval = 0, },
    { .ctl_name = "DAC1 Volume", .intval = 96, },
    { .ctl_name = "SPKL DAC1 Volume", .intval = 1, },
    { .ctl_name = "SPKR DAC1 Volume", .intval = 1, },
    { .ctl_name = "Speaker Mixer Volume", .intval = 3, },
    { .ctl_name = "Speaker Boost Volume", .intval = 6, },
    { .ctl_name = "Speaker Volume", .intval = 58, },
    { .ctl_name = NULL, },
};

struct route_setting speaker_input_disable[] = {
    { .ctl_name = "AIF2DAC Volume", .intval = 96, },
    { .ctl_name = "AIF2 Boost Volume", .intval = 0, },
    { .ctl_name = "DAC1 Volume", .intval = 96, },
    { .ctl_name = "SPKL DAC1 Volume", .intval = 0, },
    { .ctl_name = "SPKR DAC1 Volume", .intval = 0, },
    { .ctl_name = "Speaker Mixer Volume", .intval = 0, },
    { .ctl_name = "Speaker Volume", .intval = 57, },
    { .ctl_name = "Speaker Boost Volume", .intval = 0, },
    { .ctl_name = NULL, },
};
...
struct route_setting headset_input_disable[] = {
    ...
    { .ctl_name = "Left Output Mixer DAC Volume", .intval = 7, },
    { .ctl_name = "Right Output Mixer DAC Volume", .intval = 7, },
    { .ctl_name = "Headphone Volume", .intval = 45, },
    { .ctl_name = NULL, },
};
